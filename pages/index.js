        ...
        <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
            ...
            <div className="xl:max-w-lg xl:ml-auto">
                ...
                <div className="mt-4 sm:mt-6">
                    <a href="#" className="inline-block bg-indigo-500 text-white px-4 py-2 rounded shadow-lg uppercase tracking-wider font-semibold text-sm sm:text-base">Book your escape</a>
                </div>
            </div>
